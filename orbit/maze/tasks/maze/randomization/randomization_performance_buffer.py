...
class RandomizationPerformanceBuffer:
    def __init__(self, randomized_parameters: List[RandomizationParameter], buffer_size: int):
        """
    ...
    @staticmethod
    def _init_buffer(randomization_parameters: List[RandomizationParameter], buffer_size: int) -> dict:
        """
